...
async function main(userId, arrayOwner, arrayNameOwner, thuasodat, tobandoso, cacsothuagiapranh, dientich, toadocacdinh, chieudaicaccanh, hinhthucsudung, mucdichsudung, thoihansudung, nguongocsudung, thoigiandangky, nhaO, congtrinhkhac, url, laneOfCity) {
    try {
        ...
        await contract.submitTransaction('createLandCo', arrayOwner, arrayNameOwner, thuasodat, tobandoso, cacsothuagiapranh, dientich, toadocacdinh, chieudaicaccanh, hinhthucsudung, mucdichsudung, thoihansudung, nguongocsudung, thoigiandangky, nhaO, congtrinhkhac, url, laneOfCity);
